...
```bash 
 $ sudo apt update
 ```
#### `Step 2` Save the installer in /tmp
```bash 
$ curl https://raw.githubusercontent.com/rapid7/metasploit-omnibus/master/config/templates/metasploit-framework-wrappers/msfupdate.erb > /tmp/msfinstall
```
#### `Step 3` Giving  execute permission for installer
```bash 
...
#### Done installing call using msfconsole of msfvenom 
```bash
root@LinuxMachine:~# msfconsole
...
+ -- --=[ 2227 exploits - 1174 auxiliary - 398 post       ]
